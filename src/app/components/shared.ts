...
export const MISSIONS: Mission[] = [
  { id: 'layout-a', layout: 'Layout A', name: 'Tipping Point',       subtitle: 'Zonas diagonales',   deployment: 'diagonal'    },
  { id: 'layout-b', layout: 'Layout B', name: 'Hammer and Anvil',    subtitle: 'Franjas verticales', deployment: 'hammer'      },
  { id: 'layout-c', layout: 'Layout C', name: 'Crossfire',           subtitle: 'Arcos de esquina',   deployment: 'corner'      },
];
